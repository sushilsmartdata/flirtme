...
.factory('UserService', ['$http', 'communicationService', function($http, communicationService) {
	...
	service.monthwiseData = function(callback) {
		console.log("here")
		communicationService.resultViaGet(webservices.malefemalemonthly, appConstants.authorizationKey, headerConstants.json, function(response) {
			callback(response);
		});
	}

...
flirtme.controller('loginController', ['$stateParams', '$state','$scope', '$rootScope', '$location', 'AuthenticationService', '$localStorage', '$auth','SweetAlert','UserService', '$timeout', function($stateParams, $state,$scope, $rootScope, $location, AuthenticationService, $localStorage, $auth,SweetAlert,UserService, $timeout){
	var inputJSON = "";
